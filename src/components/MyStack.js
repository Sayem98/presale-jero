      ...
      <div className="max-w-full rounded-xl mb-4 bg-white p-3 overflow-hidden shadow-lg bg-transparent border-2">
        ...
        <form>
          ...
          <div className=" mt-4 w-full">
            ...
            <div>
              <label className="text-md font-medium  text-yellow-700">
                JERO Reward
              </label>
            </div>
            <div className="mt-1 flex rounded-md hover:border-white border-0 mb-4 bg-gray-50 shadow-sm">
              ...
              <button
                type="button"
                className="inline-flex items-center p-1 px-4 rounded-md border-2 m-2 border-yellow-700 bg-gray-50 text-yellow-700 text-md"
                onClick={() => {
                  WithdrawReward();
                }}
              >
